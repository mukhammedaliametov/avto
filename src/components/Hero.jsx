...
const Hero = () => {
  return (
    ...
    >
      <div className="max-w-[1220px] mx-auto px-[16px] xl:px-0 pt-[60px] font-montserrat text-white">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center mt-[20px]">
          <div className="flex flex-col gap-[20px] mt-[130px] md:mt-0">
            <button
              style={{
            ...
            <div className="relative ml-[20px] flex items-center w-full md:w-[235px] h-[52px] border border-amber-400 rounded-[10px] gap-[12px] pl-[34px] pr-[20px] text-[14px]">
              ...
              />
              <p>Специально <br /> обученные механики</p>
            </div>
            <div className="relative ml-[20px] flex items-center w-full md:w-[235px] h-[52px] border border-amber-400 rounded-[10px] gap-[12px] pl-[34px] pr-[20px] text-[14px]">
              <img
                src={KingIcon}
          ...
          <div className="relative w-full mx-auto md:w-[1120px] md:ml-[120px] "> 
            <h1 className="text-[40px] md:text-[60px] lg:text-[80px] font-[800] ml-[30px] md:ml-0">F812 SUPER</h1>
            <img src={FerrariImage} alt="ferrari_img" className="absolute mt-[-35px] md:mt-[-50px] lg:mt-[-80px] md:left-[-40px] z-20" />
